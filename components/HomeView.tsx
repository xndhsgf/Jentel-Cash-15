...
const HomeView: React.FC<HomeViewProps> = ({ user, appConfig, onPurchase, products, banners, categories }) => {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-transparent rtl">
      ...
      */}
      <div className="fixed top-16 left-0 right-0 z-[60] max-w-lg mx-auto bg-[#0c0f17]/90 backdrop-blur-xl border-b border-white/5 pb-1">
        ...
        {/* 2. البنرات الإعلانية - تم تقليل الحواف العلوية والسفلية */}
        ...
        {/* 3. الأقسام - تم ضغط المسافات تماماً لرفع تصفح الأقسام */}
        ...
        {/* 4. شريط اسم القسم - تم ضغط الهوامش ليكون ملتصقاً بما فوقه */}
        <div className="px-5 py-1">
           <div className="flex items-center justify-between bg-black/70 backdrop-blur-2xl rounded-2xl p-2.5 border border-white/10 shadow-xl">
              ...
              <div className="flex flex-col items-end">
                 ...
                 <div className="w-8 h-0.5 bg-yellow-400 rounded-full mt-1.5"></div>
              </div>
           </div>
        </div>
      </div>
      ...
      {/* 
          ...
          تم تقليل الـ pt لتتناسب مع ارتفاع الهيدر الجديد المضغوط
      */}
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 pt-[310px] pb-32 relative z-[50] text-right bg-transparent">
